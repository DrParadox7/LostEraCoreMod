...
public enum Mixins {
    ...
    AROMAMIXIN(new Builder("AromaMixin").setPhase(Phase.LATE).setSide(Side.BOTH)
            .addMixinClasses(
                    "aroma.MixinBiomeGenMining",
                    "aroma.MixinChunkProviderMining",
                    "aroma.MixinWorldProviderMiner")
            .setApplyIf(() -> false).addTargetedMod(TargetedMod.AROMA)),
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        Pokepatch.logger.info("Failed to load the following EARLY Mixins: {}", notLoading.toString());
        return mixins;
    }
    ...
    public static List<String> getLateMixins(Set<String> loadedMods) {
        ...
        Pokepatch.logger.info("Failed to load the following LATE Mixins: {}", notLoading.toString());
        return mixins;
    }
